...
import { cellType, datumType, censusType, DataItem } from './TypeLib';
...
class App extends Component<{}, {}, null> {
  ...
  public render() {
    return (
      <div key="main">
        <ControlPanel ref={ this.panel } width={ 2000 } height={ 30 } padding={ [8, 5] } mapViewChange={ this.mapViewChange.bind(this) } merge={ this.merge.bind(this) } />
